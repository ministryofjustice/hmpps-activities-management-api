...
dependencies {
  ...
  implementation("aws.sdk.kotlin:s3:1.9.6")
  ...
  testImplementation("org.mockito.kotlin:mockito-kotlin:6.4.0") // temp, fix version to prevent dependency clash between sar test support lib and hmpps kotlin plugin
