...
-- insert the regime times needed for WMI after migration
-- Mon - Friday
insert into prison_regime (prison_code, am_start, am_finish, pm_start, pm_finish, ed_start, ed_finish)
VALUES ('WMI', '08:30:00', '11:30:00', '13:45:00', '16:30:00', '17:30:00', '19:30:00');
...
-- Sat - Sunday
insert into prison_regime (prison_code, am_start, am_finish, pm_start, pm_finish, ed_start, ed_finish)
VALUES ('WMI', '08:45:00', '11:15:00', '13:45:00', '16:15:00', '17:30:00', '19:30:00');

insert into prison_regime_days_of_week(prison_regime_id, day_of_week)
values ((select prison_regime_id from prison_regime where prison_code = 'WMI' and am_start = '08:45:00'), 'SATURDAY'),
((select prison_regime_id from prison_regime where prison_code = 'WMI' and am_start = '08:45:00'), 'SUNDAY');
