...
-- This check isn't strictly necessary in preprod/prod migrations though, but its harmless
-- to include it and keeps the script identical to that used in the dev migration
DO $$
BEGIN
