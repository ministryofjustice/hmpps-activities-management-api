...
fun AppointmentAttendanceMarkedEvent.toTelemetryPropertiesMap() = mutableMapOf(
...
fun AppointmentAttendanceMarkedEvent.toTelemetryMetricsMap() = mutableMapOf(
...
fun AppointmentSet.toTelemetryMetricsMap() = mutableMapOf(
...
fun AppointmentUpdateRequest.toTelemetryMetricsMap(appointmentCount: Int, appointmentInstanceCount: Int) = mutableMapOf(
