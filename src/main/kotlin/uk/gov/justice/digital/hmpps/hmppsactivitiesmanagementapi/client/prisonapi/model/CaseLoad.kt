...
data class CaseLoad(
  ...
  @get:JsonProperty("caseLoadId", required = true) val caseLoadId: String,
  ...
  @get:JsonProperty("currentlyActive", required = true) val currentlyActive: Boolean,

  @Schema(example = "GENERAL", description = "Functional Use of the case load")
  @get:JsonProperty("caseloadFunction") val caseloadFunction: CaseloadFunction? = null
) {
  /**
