...
@Schema(description = "Describes a pay rate applied to an activity")
data class ActivityPayLite(
  ...
  @Schema(description = "The pay band id for this activity pay", example = "123456")
