...
data class SentenceCalcDates(
  ...
  @JsonProperty("sentenceStartDate") val sentenceStartDate: LocalDate,
  ...
  @JsonProperty("nonDtoReleaseDateType") val nonDtoReleaseDateType: NonDtoReleaseDateType,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "SED - date on which sentence expires.")
  @JsonProperty("sentenceExpiryDate") val sentenceExpiryDate: LocalDate? = null,
  ...
  @JsonProperty("automaticReleaseDate") val automaticReleaseDate: LocalDate? = null,
  ...
  @JsonProperty("conditionalReleaseDate") val conditionalReleaseDate: LocalDate? = null,
  ...
  @JsonProperty("nonParoleDate") val nonParoleDate: LocalDate? = null,
  ...
  @JsonProperty("postRecallReleaseDate") val postRecallReleaseDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "LED - date on which offender licence expires.")
  @JsonProperty("licenceExpiryDate") val licenceExpiryDate: LocalDate? = null,
  ...
  @JsonProperty("homeDetentionCurfewEligibilityDate") val homeDetentionCurfewEligibilityDate: LocalDate? = null,
  ...
  @JsonProperty("paroleEligibilityDate") val paroleEligibilityDate: LocalDate? = null,
  ...
  @JsonProperty("homeDetentionCurfewActualDate") val homeDetentionCurfewActualDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "APD - the offender's actual parole date.")
  @JsonProperty("actualParoleDate") val actualParoleDate: LocalDate? = null,
  ...
  @JsonProperty("releaseOnTemporaryLicenceDate") val releaseOnTemporaryLicenceDate: LocalDate? = null,
  ...
  @JsonProperty("earlyRemovalSchemeEligibilityDate") val earlyRemovalSchemeEligibilityDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "ETD - early term date for offender.")
  @JsonProperty("earlyTermDate") val earlyTermDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "MTD - mid term date for offender.")
  @JsonProperty("midTermDate") val midTermDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "LTD - late term date for offender.")
  @JsonProperty("lateTermDate") val lateTermDate: LocalDate? = null,
  ...
  @JsonProperty("topupSupervisionExpiryDate") val topupSupervisionExpiryDate: LocalDate? = null,
  ...
  @JsonProperty("tariffDate") val tariffDate: LocalDate? = null,
  ...
  @JsonProperty("dtoPostRecallReleaseDate") val dtoPostRecallReleaseDate: LocalDate? = null,
  ...
  @JsonProperty("tariffEarlyRemovalSchemeEligibilityDate") val tariffEarlyRemovalSchemeEligibilityDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "Effective sentence end date")
  @JsonProperty("effectiveSentenceEndDate") val effectiveSentenceEndDate: LocalDate? = null,

  @Schema(example = "5", description = "ADA - days added to sentence term due to adjustments.")
  @JsonProperty("additionalDaysAwarded") val additionalDaysAwarded: Int? = null,
  ...
  @JsonProperty("automaticReleaseOverrideDate") val automaticReleaseOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("conditionalReleaseOverrideDate") val conditionalReleaseOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("nonParoleOverrideDate") val nonParoleOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("postRecallReleaseOverrideDate") val postRecallReleaseOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("dtoPostRecallReleaseDateOverride") val dtoPostRecallReleaseDateOverride: LocalDate? = null,
  ...
  @JsonProperty("nonDtoReleaseDate") val nonDtoReleaseDate: LocalDate? = null,
  ...
  @JsonProperty("sentenceExpiryCalculatedDate") val sentenceExpiryCalculatedDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Feb 03 00:00:00 GMT 2020", description = "SED (override) - date on which sentence expires.")
  @JsonProperty("sentenceExpiryOverrideDate") val sentenceExpiryOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("licenceExpiryCalculatedDate") val licenceExpiryCalculatedDate: LocalDate? = null,
  ...
  @JsonProperty("licenceExpiryOverrideDate") val licenceExpiryOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("paroleEligibilityCalculatedDate") val paroleEligibilityCalculatedDate: LocalDate? = null,
  ...
  @JsonProperty("paroleEligibilityOverrideDate") val paroleEligibilityOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("topupSupervisionExpiryCalculatedDate") val topupSupervisionExpiryCalculatedDate: LocalDate? = null,
  ...
  @JsonProperty("topupSupervisionExpiryOverrideDate") val topupSupervisionExpiryOverrideDate: LocalDate? = null,
  ...
  @JsonProperty("homeDetentionCurfewEligibilityCalculatedDate") val homeDetentionCurfewEligibilityCalculatedDate: LocalDate? = null,
  ...
  @JsonProperty("homeDetentionCurfewEligibilityOverrideDate") val homeDetentionCurfewEligibilityOverrideDate: LocalDate? = null,

  @Valid
  @Schema(example = "Mon Apr 20 01:00:00 BST 2020", description = "Confirmed release date for offender.")
  @JsonProperty("confirmedReleaseDate") val confirmedReleaseDate: LocalDate? = null,
  ...
  @JsonProperty("releaseDate") val releaseDate: LocalDate? = null,
  ...
  @JsonProperty("topupSupervisionStartDate") val topupSupervisionStartDate: LocalDate? = null,
  ...
  @JsonProperty("homeDetentionCurfewEndDate") val homeDetentionCurfewEndDate: LocalDate? = null
) {
