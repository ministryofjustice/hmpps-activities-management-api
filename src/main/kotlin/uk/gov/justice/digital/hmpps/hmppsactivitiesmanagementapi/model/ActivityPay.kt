...
data class ActivityPay(
  ...
  @Schema(description = "The incentive/earned privilege basic rate per occurrence for this activity", example = "100")
  val iepBasicRate: Int? = null,

  @Schema(description = "The incentive/earned privilege standard rate per occurrence for this activity", example = "125")
  val iepStandardRate: Int? = null,

  @Schema(description = "The incentive/earned privilege enhanced rate per occurrence for this activity", example = "150")
