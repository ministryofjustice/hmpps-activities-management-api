...
class ScheduledInstanceController(
  ...
  @PreAuthorize("hasAnyRole('PRISON', 'ACTIVITY_ADMIN')")
  @Deprecated(message = "Will be replaced by uncancelScheduledInstances")
  ...
  @PutMapping(value = ["/uncancel"])
  @ResponseBody
  @Operation(
    summary = "Uncancel multiple schedule instances",
  ...
  @PreAuthorize("hasAnyRole('PRISON', 'ACTIVITY_ADMIN')")
  fun uncancelScheduledInstances(
    @Valid
    @RequestBody
    @Parameter(
  ...
  @ResponseBody
  @Operation(
    summary = "Cancel multiple schedule instances",
  ...
  fun cancelScheduledInstances(
    ...
    request: ScheduleInstancesCancelRequest,
  ): ResponseEntity<Any> = scheduledInstanceService.cancelScheduledInstances(request).let { ResponseEntity.noContent().build() }
