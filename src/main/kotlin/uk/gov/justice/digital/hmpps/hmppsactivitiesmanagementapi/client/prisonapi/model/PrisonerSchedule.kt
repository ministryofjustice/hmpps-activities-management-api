...
data class PrisonerSchedule(
    ...
    @Schema(example = "null", description = "The number which (uniquely) identifies the internal location associated with the Scheduled Event (Prisoner Schedule)")
    ...
    @Schema(example = "null", description = "Attendance, possible values are the codes in the 'PS_PA_OC' reference domain")
