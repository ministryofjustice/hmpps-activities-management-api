...
interface AppointmentAttendanceSummaryRepository : ReadOnlyRepository<AppointmentAttendanceSummary, Long> {
  ...
  fun findByPrisonCodeAndStartDateAndCustomNameIgnoreCase(prisonCode: String, startDate: LocalDate, customName: String): List<AppointmentAttendanceSummary>
  fun findByPrisonCodeAndStartDateAndCategoryCodeAndCustomNameIgnoreCase(prisonCode: String, startDate: LocalDate, categoryCode: String, customName: String): List<AppointmentAttendanceSummary>
}
