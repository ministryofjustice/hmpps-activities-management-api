...
interface ActivityRepository : JpaRepository<Activity, Long> {
  ...
  @EntityGraph(attributePaths = ["schedules"], type = EntityGraph.EntityGraphType.LOAD)
  @Query(value = "from Activity a where a.activityId = :activityId")
  fun findByIdWithLimitedCollections(@Param("activityId") activityId: Long): Optional<Activity>
}
