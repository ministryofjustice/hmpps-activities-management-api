        ...
        appointmentAttendeeRepository.findById(it.appointmentAttendeeId)
          .ifPresent { attendee ->
            transactionHandler.newSpringTransaction {
              ...
              outboundEventsService.sendAppointmentEvent(OutboundEvent.APPOINTMENT_INSTANCE_DELETED, updatedAttendee.appointmentAttendeeId, updatedAttendee.appointment.categoryCode)
            }
