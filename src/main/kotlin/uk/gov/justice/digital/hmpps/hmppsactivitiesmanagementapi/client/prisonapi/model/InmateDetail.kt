...
data class InmateDetail(
  ...
  @JsonProperty("offenderId") val offenderId: Long,

  @Schema(example = "null", description = "Internal Root Offender ID")
  @JsonProperty("rootOffenderId") val rootOffenderId: Long,
  ...
  @JsonProperty("dateOfBirth") val dateOfBirth: java.time.LocalDate,

  @Schema(example = "null", description = "Indicates that the person is currently in prison")
  @JsonProperty("activeFlag") val activeFlag: Boolean,

  @Schema(example = "IN", description = "In/Out Status")
  @JsonProperty("inOutStatus") val inOutStatus: InOutStatus?,
  ...
  @JsonProperty("bookingNo") val bookingNo: String? = null,
  ...
  @JsonProperty("facialImageId") val facialImageId: Long? = null,
  ...
  @JsonProperty("assignedLivingUnitId") val assignedLivingUnitId: Long? = null,

  @Schema(example = "null", description = "Religion of the prisoner")
  @JsonProperty("religion") val religion: String? = null,

  @Schema(example = "null", description = "Preferred spoken language")
  @JsonProperty("language") val language: String? = null,

  @Schema(example = "null", description = "Interpreter required")
  @JsonProperty("interpreterRequired") val interpreterRequired: Boolean? = null,

  @Schema(example = "null", description = "Preferred written language")
  @JsonProperty("writtenLanguage") val writtenLanguage: String? = null,

  @Schema(example = "null", description = "List of Alerts")
  @JsonProperty("alertsCodes") val alertsCodes: List<String>? = null,

  @Schema(example = "null", description = "number of active alerts. Note: Full Details Only")
  @JsonProperty("activeAlertCount") val activeAlertCount: Long? = null,

  @Schema(example = "null", description = "number of inactive alerts. Note: Full Details Only")
  @JsonProperty("inactiveAlertCount") val inactiveAlertCount: Long? = null,

  @Valid
  @Schema(example = "null", description = "List of alert details")
  @JsonProperty("alerts") val alerts: List<Alert>? = null,

  @Valid
  @Schema(example = "null", description = "")
  @JsonProperty("assignedLivingUnit") val assignedLivingUnit: AssignedLivingUnit? = null,

  @Valid
  @Schema(example = "null", description = "")
  @JsonProperty("physicalAttributes") val physicalAttributes: PhysicalAttributes? = null,

  @Valid
  @Schema(example = "null", description = "List of physical characteristics")
  @JsonProperty("physicalCharacteristics") val physicalCharacteristics: List<PhysicalCharacteristic>? = null,

  @Valid
  @Schema(example = "null", description = "List of profile information")
  @JsonProperty("profileInformation") val profileInformation: List<ProfileInformation>? = null,

  @Valid
  @Schema(example = "null", description = "List of physical marks")
  @JsonProperty("physicalMarks") val physicalMarks: List<PhysicalMark>? = null,

  @Valid
  @Schema(example = "null", description = "List of assessments")
  @JsonProperty("assessments") val assessments: List<Assessment>? = null,

  @Schema(example = "null", description = "CSRA (Latest assessment with cellSharing=true from list of assessments)")
  @JsonProperty("csra") val csra: String? = null,

  @Schema(example = "STANDARD", description = "The CSRA classification (calculated from the list of CSRA assessments)")
  @JsonProperty("csraClassificationCode") val csraClassificationCode: String? = null,

  @Valid
  @Schema(example = "null", description = "The date that the csraClassificationCode was assessed")
  @JsonProperty("csraClassificationDate") val csraClassificationDate: java.time.LocalDate? = null,
  ...
  @JsonProperty("imprisonmentStatusDescription") val imprisonmentStatusDescription: String? = null,

  @Valid
  @Schema(example = "null", description = "")
  @JsonProperty("privilegeSummary") val privilegeSummary: PrivilegeSummary? = null,

  @Valid
  @Schema(example = "Tue Jan 01 00:00:00 GMT 1980", description = "Date prisoner was received into the prison.")
  @JsonProperty("receptionDate") val receptionDate: java.time.LocalDate? = null,
  ...
  @JsonProperty("latestLocationId") val latestLocationId: String? = null
) {
