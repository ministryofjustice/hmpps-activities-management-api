...
class AppointmentCancelledEventTest : AuditableEventTestBase() {
  ...
  fun `returns correct string representation`() {
    val event = createEvent()
    val expectedToString = "An appointment with id '2' from series id '1' at prison PBI was cancelled. Event created on 2023-03-22 at 09:00:03 by CANCELLED_BY_USER."
  ...
  fun `returns the correct json representation`() {
    val event = createEvent()
    val expectedJson =
      """{"appointmentSeriesId":1,"appointmentId":2,"prisonCode":"PBI","applyTo":"ALL_FUTURE_APPOINTMENTS","createdTime":"2023-03-22T09:00:03","createdBy":"CANCELLED_BY_USER"}"""
