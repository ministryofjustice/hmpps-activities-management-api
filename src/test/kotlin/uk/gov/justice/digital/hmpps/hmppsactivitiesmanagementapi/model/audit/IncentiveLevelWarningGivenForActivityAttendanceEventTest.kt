...
class IncentiveLevelWarningGivenForActivityAttendanceEventTest : AuditableEventTestBase() {
  ...
  fun `returns correct type`() {
    val event = IncentiveLevelWarningGivenForActivityAttendanceEvent(
      1,
      "Some Activity",
      "PBI",
      42,
  ...
  fun `returns correct string representation`() {
    ...
    val expectedToString = "An incentive level warning was given to prisoner A123456 for activity 'Some Activity'(1) " +
