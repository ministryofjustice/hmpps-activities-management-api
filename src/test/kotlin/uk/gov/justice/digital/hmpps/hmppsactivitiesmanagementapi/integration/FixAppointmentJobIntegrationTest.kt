...
class FixAppointmentJobIntegrationTest : IntegrationTestBase() {
  @Autowired
  ...
  @Sql("classpath:test_data/seed-fix-appointment-locations-job.sql")
  @Test
  fun `should update appointment location details`() {
    ...
    val dpsLocation1 = dpsLocation(uuid1, "MDI", "L1", "Location 1")
    val dpsLocation2 = dpsLocation(uuid2, "MDI", "L2", "Location 2")
    val dpsLocation6 = dpsLocation(uuid6, "MDI", "L6", "Location 6")
  ...
  fun assertAppointmentSet(id: Long, locationId: Long?, dpsLocationId: UUID?) {
    ...
    assertThat(appointment.internalLocationId).isEqualTo(locationId)
    assertThat(appointment.dpsLocationId).isEqualTo(dpsLocationId)
  }
