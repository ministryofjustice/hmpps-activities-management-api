...
object PrisonerSearchPrisonerFixture {
  ...
  fun pagedResultWithSurnames(prisonerNumberAndSurnames: List<Pair<String, String>> = listOf("G4793VF" to "Harrison")) = PagedPrisoner(content = prisonerNumberAndSurnames.sortedBy { it.second }.map { instance(prisonerNumber = it.first, lastName = it.second) })
