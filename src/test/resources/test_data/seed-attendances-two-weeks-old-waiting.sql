...
values (1, 'PVI', 1, 1, true, false, false, false, 'H', 'Maths', 'Maths Level 1', current_date - 15, null, 'high', 'BAS', 'Basic', '2022-9-21 00:00:00', 'SEED USER');
...
values (1, 1, 'Maths AM', 1, 'L1', 'Location 1', 10, current_date - 15);
...
values (1, current_date - 15, '10:00:00', '11:00:00', false, null, null, null, null);
...
values (1, 1, 'A11111A', 9, null, current_timestamp - 14, 'MR BLOGS', 'WAITING', null, null, null);
