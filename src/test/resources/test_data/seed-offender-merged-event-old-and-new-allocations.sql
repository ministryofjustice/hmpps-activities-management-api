...
insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, tuesday_flag, wednesday_flag, thursday_flag, friday_flag, saturday_flag, sunday_flag, time_slot)
values (2, 2, '12:01:00', '12:02:00', true, true, true, true, true, true, true, 'PM');
...
insert into appointment_series (appointment_series_id, appointment_type, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
values (2, 'INDIVIDUAL', 'PVI', 'OIC', 1, 123, false, now()::date + 1, '08:30', '10:00', now()::timestamp, 'TEST.USER');

insert into appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
values (3, 2, 1, 'PVI', 'OIC', 1, 123, false, now()::date + 1, '08:30', '10:00', now()::timestamp, 'TEST.USER');
