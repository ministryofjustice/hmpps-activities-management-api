...
insert into activity_schedule(activity_schedule_id, activity_id, description, dps_location_id, internal_location_id, internal_location_code, internal_location_description, capacity, start_date)
values (1, 1, 'Maths AM', '11111111-1111-1111-1111-111111111111', 1, 'L1', 'Location 1', 10, '2022-10-10');
...
insert into activity_schedule(activity_schedule_id, activity_id, description, dps_location_id, internal_location_id, internal_location_code, internal_location_description, capacity, start_date)
values (2, 1, 'Maths PM', '22222222-2222-2222-2222-222222222222', 2, 'L2', 'Location 2', 10, '2022-10-10');
...
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (4, 2, 'A11111A', 10001, 3, '2022-10-12', null, '2022-10-10 10:00:00', 'MR BLOGS', null, null, null, null, null, null, 'ACTIVE');

insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (5, 2, 'A22222A', 10002, 3, '2022-10-12', null, '2022-10-10 10:00:00', 'MRS BLOGS', null, null, null, null, null, null, 'ACTIVE');

insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (6, 2, 'A1234BC', 10004, 3, current_timestamp + interval '2 day', null, '2022-10-10 10:00:00', 'MRS BLOGS', null, null, null, null, null, null, 'PENDING');
...
insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment, time_slot)
values (2, current_timestamp, '10:00:00', '11:00:00', false, null, null, null, null, 'AM');
...
insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment, time_slot)
values (2, '2022-10-10', '14:00:00', '15:00:00', false, null, null, null, null, 'PM');
...
insert into activity(activity_id, prison_code, activity_category_id, activity_tier_id, attendance_required, in_cell, piece_work, outside_work, pay_per_session, summary, description, start_date, end_date, risk_level, created_time, created_by, paid)
values (2, 'RSI', 1, 1, false, false, false, false, 'H', 'English', 'English Level 1', '2022-10-10', null, 'high', '2022-9-21 00:00:00', 'SEED USER', false);

insert into activity_schedule(activity_schedule_id, activity_id, description, internal_location_id, internal_location_code, internal_location_description, dps_location_id, capacity, start_date)
values (3, 2, 'English AM', null, null, null, null, 10, '2022-10-10');

insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment, time_slot)
values (3, '2022-10-10', '14:00:00', '15:00:00', false, null, null, null, null, 'PM');
