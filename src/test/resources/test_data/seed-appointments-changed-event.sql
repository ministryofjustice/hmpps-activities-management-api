...
VALUES (100, 'INDIVIDUAL', 'MDI', 'OIC', 1, 123, false, now()::date + 1, '08:30', '10:00', now()::timestamp, 'TEST.USER');
...
VALUES (200, 100, 1, 'MDI', 'OIC', 1, 123, false, now()::date + 1, '08:30', '10:00', now()::timestamp, 'TEST.USER');
...
VALUES (101, 'INDIVIDUAL', 'MDI', 'AC2', 'Art Class', 1, 456, false,now()::date + 1, '13:00', '15:00', now()::timestamp, 'DIFFERENT.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
VALUES (201, 101, 1, 'MDI', 'AC2', 1, 456, false, now()::date + 1, '13:00', '15:00', now()::timestamp, 'DIFFERENT.USER');
INSERT INTO appointment_attendee (appointment_attendee_id, appointment_id, prisoner_number, booking_id)
...
INSERT INTO appointment_series (appointment_series_id, appointment_type, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
VALUES (103, 'INDIVIDUAL', 'OTH', 'OIC', 1, 789, false, now()::date + 1, '09:00', '10:30', now()::timestamp, 'OTHER.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
VALUES (203, 103, 1, 'OTH', 'OIC', 1, 789, false, now()::date + 1, '09:00', '10:30', now()::timestamp, 'OTHER.USER');
INSERT INTO appointment_attendee (appointment_attendee_id, appointment_id, prisoner_number, booking_id)
...
VALUES (110, 'GROUP', 'MDI', 'OIC', 1, 123, false, now()::date - 7, '09:00', '10:30', 10, now()::timestamp, 'TEST.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, created_time, created_by)
VALUES (210, 110, 1, 'MDI', 'OIC', 1, 123, false, now()::date - 7, '09:00', '10:30', now()::timestamp, 'TEST.USER');
...
VALUES (211, 110, 2, 'MDI', 'OIC', 1, 456, false, now()::date + 1, '13:30', '15:00', now()::timestamp, 'TEST.USER', now()::timestamp, 'DIFFERENT.USER');
...
VALUES (212, 110, 3, 'MDI', 'OIC', 1, 123, false, now()::date + 7, '09:00', '10:30', now()::timestamp, 'TEST.USER', now()::timestamp, 2, 'DIFFERENT.USER');
...
VALUES (213, 110, 4, 'MDI', 'OIC', 1, 123, false, now()::date + 14, '09:00', '10:30', now()::timestamp, 'TEST.USER', now()::timestamp, 1, 'DIFFERENT.USER', true);
INSERT INTO appointment_attendee (appointment_attendee_id, appointment_id, prisoner_number, booking_id)
