...
values (1, 1, '00:00:00', '00:01:00', true, true, true, true, true, true, true);
...
values (1, current_date, '00:00:00', '00:01:00', false, null, null, null, null);

insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment)
values (1, current_date + 1, '00:00:00', '00:01:00', false, null, null, null, null);
...
insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, tuesday_flag, wednesday_flag, thursday_flag, friday_flag, saturday_flag, sunday_flag)
values (2, 2, '00:00:00', '00:01:00', true, true, true, true, true, true, true);

insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment)
values (2, current_date, '00:00:00', '00:01:00', false, null, null, null, null);

insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment)
values (2, current_date + 1, '00:00:00', '00:01:00', false, null, null, null, null);
...
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (2, 2, 'A11111A', 10001, 1, '2022-10-10', null, '2022-10-10 09:00:00', 'MR BLOGS', null, null, null, null, null, null, 'SUSPENDED');
...
values (1, 1, 'A11111A', 7, null, current_timestamp, 'Activities Management Service', 'COMPLETED', false);
...
insert into planned_suspension(planned_suspension_id, allocation_id, planned_start_date, planned_end_date, planned_by, planned_at, updated_by, updated_at)
values (2, 2, current_date - 2, current_date + 2, 'MRS BLOGS', current_timestamp, 'MRS BLOGS', current_timestamp);
