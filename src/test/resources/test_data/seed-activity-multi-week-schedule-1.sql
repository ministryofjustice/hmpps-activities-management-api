...
values (1, 'PVI', 1, 1, true, false, true, true, 'H', 'Maths', 'Maths Level 1', '2022-10-10', null, 'high', 'BAS', 'Basic', '2022-9-21 00:00:00', 'SEED USER', true);
...
insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, wednesday_flag, week_number)
values (1, 1, '10:00:00', '11:00:00', true, true, 1);

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, thursday_flag, week_number)
values (2, 1, '13:00:00', '14:00:00', true, true, 1);

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, tuesday_flag, friday_flag, week_number)
values (3, 1, '10:00:00', '11:00:00', true, true, 2);

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, thursday_flag, week_number)
values (4, 1, '13:00:00', '14:00:00', true, true, 2);
