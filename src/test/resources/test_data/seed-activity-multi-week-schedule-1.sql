...
insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, thursday_flag, week_number, time_slot)
values (2, 1, '13:00:00', '14:00:00', true, true, 1, 'PM');

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, tuesday_flag, friday_flag, week_number, time_slot)
values (3, 1, '10:00:00', '11:00:00', true, true, 2, 'AM');

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, thursday_flag, week_number, time_slot)
values (4, 1, '13:00:00', '14:00:00', true, true, 2, 'PM');
