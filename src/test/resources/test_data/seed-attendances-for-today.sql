...
values (1, 'PVI', 1, 1, true, false, false, false, 'H', 'Maths', 'Maths Level 1', current_date, null, 'high', 'BAS', 'Basic', '2022-9-21 00:00:00', 'SEED USER', true);
...
values (1, 1, 'A11111A', 10001, 1, '2022-10-10', null, current_timestamp, 'MR BLOGS', null, null, null, null, null, null, 'ACTIVE');

insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (2, 1, 'A22222A', 10001, 1, '2022-10-10', null, current_timestamp, 'MR BLOGS', null, null, null, null, null, null, 'ACTIVE');
...
values (1, 1, 'A11111A', 9, null, current_timestamp, 'MR BLOGS', 'COMPLETED', null, null, null, true);

insert into attendance(attendance_id, scheduled_instance_id, prisoner_number, attendance_reason_id, comment, recorded_time, recorded_by, status, pay_amount, bonus_amount, pieces, paid)
values (2, 1, 'A22222A', 9, null, current_timestamp, 'MR BLOGS', 'WAITING', null, null, null, true);
