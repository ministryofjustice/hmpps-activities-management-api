...
VALUES (3, 'GROUP', 'MDI', 'AC1', 4, 123, false, '2022-10-01', '09:00', '10:30', 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (3, 3, 1, 'MDI', 'AC1', 4, 123, false, '2022-10-01', '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
