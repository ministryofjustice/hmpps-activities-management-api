...
values (1, 'MDI', 'ABCDEF', 1, current_date, 1, 1, 'Bob', 'PENDING', current_timestamp, 'Fred', 'Bob left some comments');

insert into waiting_list(waiting_list_id, prison_code, prisoner_number, booking_id, application_date, activity_id, activity_schedule_id, requested_by, status, creation_time, created_by, comments)
values (2, 'MDI', 'Z1111ZZ', 2, current_date, 1, 1, 'Jemima', 'WITHDRAWN', current_timestamp, 'Fred', 'Jemima left some comments');