...
values (1, 'PVI', 1, 1, true, false, false, false, 'H', 'Maths', 'Maths Level 1', current_date - 1, null, 'high', 'BAS', 'Basic', '2022-9-21 00:00:00', 'SEED USER', true);
...
values (1, 1, 'Maths AM', 1, 'L1', 'Location 1', 10, current_date - 1);
...
values (1, 1, 'A11111A', 9, null, current_timestamp - 1, 'MR BLOGS', 'COMPLETED', null, null, null, true);
