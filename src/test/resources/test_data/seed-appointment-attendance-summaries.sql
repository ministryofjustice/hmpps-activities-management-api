...
VALUES  (1, 1, 1, 'RSI', 'EDUC', 1, 123, false, now()::date - 1, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', (now()::date - 1)::timestamp, 2, 'CANCEL.USER', false, null),
        (2, 1, 2, 'RSI', 'EDUC', 1, 123, false, now()::date, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', null, null, null, false, 'custom'),
        (3, 1, 3, 'RSI', 'EDUC', 1, 123, false, now()::date - 1, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', null, null, null, false, null);
