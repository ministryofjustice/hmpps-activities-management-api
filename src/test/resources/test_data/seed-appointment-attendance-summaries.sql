...
VALUES  (1, 1, 1, 'RSI', 'EDUC', 4, 123, false, now()::date - 1, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', (now()::date - 1)::timestamp, 2, 'CANCEL.USER', false),
        (2, 1, 2, 'RSI', 'EDUC', 4, 123, false, now()::date, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', null, null, null, false),
        (3, 1, 3, 'RSI', 'EDUC', 4, 123, false, now()::date - 1, '09:00', '10:30', (now()::date - 2)::timestamp, 'TEST.USER', null, null, null, false);
...
VALUES  (2, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '13:45', '14:15', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (3, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:15', '14:45', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (4, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (5, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (6, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (7, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '13:45', '14:15', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (8, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '14:15', '14:45', 1, (now()::date - 1)::timestamp, 'TEST.USER'),
        (9, 'INDIVIDUAL', 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '14:45', '15:15', 1, (now()::date - 1)::timestamp, 'TEST.USER');
...
VALUES  (4, 2, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '13:45', '14:15', (now()::date - 1)::timestamp, 'TEST.USER', (now()::date - 1)::timestamp, 2, 'CANCEL.USER', false),
        (5, 3, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:15', '14:45', (now()::date - 1)::timestamp, 'TEST.USER', now()::timestamp, 1, 'DELETE.USER', true),
        (6, 4, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false),
        (7, 5, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false),
        (8, 6, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date - 1, '14:45', '15:15', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false),
        (9, 7, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '13:45', '14:15', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false),
        (10, 8, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '14:15', '14:45', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false),
        (11, 9, 1, 'RSI', 'CHAP', 'Jehovah''s Witness One to One', 4, 456, false, now()::date, '14:45', '15:15', (now()::date - 1)::timestamp, 'TEST.USER', null, null, null, false);
...
VALUES  (1, 'RSI', 'MEDO', 4, 789, false, now()::date, (now()::date - 1)::timestamp, 'TEST.USER');
...
VALUES  (10, 'INDIVIDUAL', 'RSI', 'MEDO', 4, 789, false, now()::date, '09:00', '09:15', (now()::date - 1)::timestamp, 'TEST.USER'),
        (11, 'INDIVIDUAL', 'RSI', 'MEDO', 4, 789, false, now()::date, '09:15', '09:30', (now()::date - 1)::timestamp, 'TEST.USER'),
        (12, 'INDIVIDUAL', 'RSI', 'MEDO', 4, 789, false, now()::date, '09:30', '09:45', (now()::date - 1)::timestamp, 'TEST.USER');
...
VALUES  (12, 10, 1, 'RSI', 'MEDO', 4, 789, false, now()::date, '09:00', '09:15', (now()::date - 1)::timestamp, 'TEST.USER'),
        (13, 11, 1, 'RSI', 'MEDO', 4, 789, false, now()::date, '09:15', '09:30', (now()::date - 1)::timestamp, 'TEST.USER'),
        (14, 12, 1, 'RSI', 'MEDO', 4, 789, false, now()::date, '09:30', '09:45', (now()::date - 1)::timestamp, 'TEST.USER');
