...
INSERT INTO appointment_occurrence (appointment_occurrence_id, appointment_id, sequence_number, internal_location_id, in_cell, start_date, start_time, end_time, comment, cancelled, cancellation_reason_id, cancelled_by, deleted)
VALUES (3, 2, 1, 123, false, now()::date + 1, '09:00', '10:30', 'Appointment occurrence level comment', now()::timestamp, 1, 'TEST.USER', true);
