...
VALUES (2, 'INDIVIDUAL', 'TPR', 'OIC', 1, 123, false, now()::date + 1, '09:00', '10:30', 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (3, 2, 1, 'TPR', 'OIC', 1, 123, false, now()::date + 1, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER', now()::timestamp, 1, 'TEST.USER', true);
