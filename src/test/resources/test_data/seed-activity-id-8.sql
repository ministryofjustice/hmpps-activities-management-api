...
insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, wednesday_flag, time_slot)
values (1, 1, '10:00:00', '11:00:00', true, true,'AM');

insert into activity_schedule_slot(activity_schedule_slot_id, activity_schedule_id, start_time, end_time, monday_flag, thursday_flag, time_slot)
values (2, 1, '13:00:00', '14:00:00', true, true, 'PM');
