...
-- ===========================
-- Repeating group appointment for PVI CHAP increments:
-- - appointmentCount by 1,
-- - appointmentInstanceCount by 3,
-- - appointmentSeriesCount by 1,
-- - appointmentSetCount by 0,
-- - cancelledAppointmentCount by 0,
-- - deletedAppointmentCount by 0,
...
VALUES  (4, 4, 1, 'PVI', 'CHAP', 4, 123, false, now()::date - 1, '09:00', '10:30', now()::timestamp, 'TEST.USER'),
        (5, 4, 2, 'PVI', 'CHAP', 4, 123, false, now()::date, '09:00', '10:30', now()::timestamp, 'TEST.USER'),
...
-- ===================================
-- Appointment set with four appointments, one cancelled, two deleted for PVI CHAP increments:
-- - appointmentCount by 4,
-- - appointmentInstanceCount by 4,
...
VALUES  (7, 5, 1, 'PVI', 'CHAP', 4, 123, false, now()::date - 1, '09:00', '09:15', now()::timestamp, 'TEST.USER', null, null, null, false),
        ...
        (9, 7, 1, 'PVI', 'CHAP', 4, 123, false, now()::date - 1, '09:00', '09:15', now()::timestamp, 'TEST.USER', now()::timestamp, 1, 'DELETE.USER', true),
