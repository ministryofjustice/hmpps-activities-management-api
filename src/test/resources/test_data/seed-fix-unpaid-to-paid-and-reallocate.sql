...
INSERT INTO data_fix (data_fix_id, activity_schedule_id, prisoner_number, start_date, prisoner_status) VALUES(1, 129, 'A8862DW', now()::date, 'ACTIVE');
INSERT INTO data_fix (data_fix_id, activity_schedule_id, prisoner_number, start_date, prisoner_status) VALUES(2, 129, 'A0334EZ', now()::date + 3, 'PENDING');
INSERT INTO data_fix (data_fix_id, activity_schedule_id, prisoner_number, start_date, prisoner_status) VALUES(3, 129, 'A1611AF', now()::date, 'AUTO_SUSPENDED');
INSERT INTO data_fix (data_fix_id, activity_schedule_id, prisoner_number, start_date, prisoner_status) VALUES(4, 129, 'A6015FC', now()::date, 'SUSPENDED');
