...
VALUES
    (1, 'INDIVIDUAL', 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', true),
    (2, 'INDIVIDUAL', 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', true),
    (3, 'INDIVIDUAL', 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', true),
    (4, 'INDIVIDUAL', 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', true);
...
VALUES
    (10, 1, 1, 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', now()::timestamp, 2, 'CANCEL.USER', false), -- Cancelled appointment
    (11, 2, 1, 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', now()::timestamp, 1, 'DELETE.USER', true), -- Deleted appointment
    (12, 3, 1, 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', null, null, null, false), -- Appointment with single temporarily removed attendee
    (13, 4, 1, 'RSI', 'CHAP', 4, 123, now()::date + 1, '09:00', '10:30', now()::timestamp, 'DPSUSER', null, null, null, false); -- Appointment with single permanently removed attendee
