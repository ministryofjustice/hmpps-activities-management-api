...
values (1, 1, 'A11111A', 10001, 1, current_timestamp, null, '2022-10-10 09:00:00', 'MRS BLOGS', current_timestamp - interval '5 hour', 'Activities Management Service', 'Temporarily released from prison', 'AUTO_SUSPENDED');

-- allocation starts tomorrow
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (2, 1, 'B22222B', 10002, 1, current_timestamp + interval '1 day', null, '2022-10-10 09:00:00', 'MRS BLOGS', current_timestamp - interval '5 hour', 'Activities Management Service', 'Temporarily released from prison', 'AUTO_SUSPENDED');

-- allocation has ended
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (3, 1, 'C33333C', 10003, 1, current_timestamp - interval '7 day', current_timestamp - interval '2 day', '2022-10-10 09:00:00', 'MRS BLOGS', current_timestamp - interval '1 day', 'Activities Management Service', 'Temporarily released from prison', 'AUTO_SUSPENDED');
...
insert into attendance(attendance_id, scheduled_instance_id, prisoner_number, attendance_reason_id, comment, recorded_time, recorded_by, status, pay_amount, bonus_amount, pieces, issue_payment)
values (2, 1, 'B22222B', 10, null, current_timestamp + interval '1 day', 'MR BLOGS', 'COMPLETED', null, null, null, false);

insert into attendance(attendance_id, scheduled_instance_id, prisoner_number, attendance_reason_id, comment, recorded_time, recorded_by, status, pay_amount, bonus_amount, pieces, issue_payment)
values (3, 1, 'C33333C', 10, null, current_timestamp + interval '1 day', 'MR BLOGS', 'COMPLETED', null, null, null, false);
