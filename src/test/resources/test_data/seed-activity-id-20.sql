...
insert into activity(activity_id, prison_code, activity_category_id, activity_tier_id, attendance_required, in_cell, piece_work, outside_work, pay_per_session, summary, description, start_date, end_date, risk_level, created_time, created_by, paid)
values (2, 'MDI', 1, 1, true, false, false, false, 'H', 'English', 'English Level 1', '2022-10-10', null, 'high', '2022-9-21 00:00:00', 'SEED USER', true);
...
values (1, 2, 'G4793VF', 10002, 2, current_date + interval '1' day, current_date + interval '1' day, '2022-10-10 09:00:00', 'MRS BLOGS', current_timestamp, 'BLOGGSJ', 'TRANSFERRED', 'ENDED');
