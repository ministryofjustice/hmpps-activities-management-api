...
values (1, 1, 'A1234AA', 10001, 1, '2022-10-10', '2022-10-10 09:00:00', 'MR BLOGS', 'ACTIVE');

insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, allocated_time, allocated_by, prisoner_status)
values (2, 2, 'A1234AA', 10001, 1, '2022-10-10', '2022-10-10 09:00:00', 'MR BLOGS', 'ACTIVE');

-- Allocation: G1234DX has KITCHEN AM only
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, allocated_time, allocated_by, prisoner_status)
values (3, 1, 'G1234DX', 10002, 1, '2022-10-10', '2022-10-10 09:00:00', 'MR BLOGS', 'ACTIVE');
