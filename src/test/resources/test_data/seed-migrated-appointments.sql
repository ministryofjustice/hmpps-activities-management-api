...
VALUES
    ...
    (3, 'INDIVIDUAL', 'MDI', 'CHAP', 4, 456, '2023-09-24', '09:00', '10:30', now()::timestamp, 'DPSUSER', true),
    ...
    (7, 'INDIVIDUAL', 'MDI', 'CHAP', 4, 456, '2023-09-25', '09:00', '10:30', now()::timestamp, 'DPSUSER', true),
...
VALUES
    ...
    (12, 3, 1, 'MDI', 'CHAP', 4, 456, '2023-09-24', '09:00', '10:30', now()::timestamp, 'DPSUSER'),
    ...
    (16, 7, 1, 'MDI', 'CHAP', 4, 456, '2023-09-25', '09:00', '10:30', now()::timestamp, 'DPSUSER'),
