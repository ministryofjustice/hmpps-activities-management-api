...
--Prisoner A1234BC, Category AC1, Location 123, Tomorrow 09:00-10:30, Created by TEST.USER
...
VALUES (100, 'INDIVIDUAL', 'TPR', 'AC1', 123, false, now()::date + 1, '09:00', '10:30', now()::timestamp, 'TEST.USER');
...
VALUES (200, 100, 1, 123, false, now()::date + 1, '09:00', '10:30');
...
--Prisoner B2345CD, Category AC2, Description Art Class, Location 456, Tomorrow 13:30-15:00, Created by DIFFERENT.USER
...
VALUES (101, 'INDIVIDUAL', 'TPR', 'AC2', 'Art Class', 456, false, now()::date + 1, '13:30', '15:00', now()::timestamp, 'DIFFERENT.USER');
INSERT INTO appointment_occurrence (appointment_occurrence_id, appointment_id, sequence_number, internal_location_id, in_cell, start_date, start_time, end_time)
VALUES (201, 101, 1, 456, false, now()::date + 1, '13:30', '15:00');
INSERT INTO appointment_occurrence_allocation (appointment_occurrence_allocation_id, appointment_occurrence_id, prisoner_number, booking_id)
VALUES (301, 201, 'B2345CD', 457);

--Prisoner A1234BC, Category AC1, In cell, Week today 09:00-10:30, Created by TEST.USER
INSERT INTO appointment (appointment_id, appointment_type, prison_code, category_code, internal_location_id, in_cell, start_date, start_time, end_time, created, created_by)
...
--Prison OTH, Prisoner A1234BC, Category AC1, Location 789, Tomorrow 09:00-10:30, Created by OTHER.USER
INSERT INTO appointment (appointment_id, appointment_type, prison_code, category_code, internal_location_id, in_cell, start_date, start_time, end_time, created, created_by)
VALUES (103, 'INDIVIDUAL', 'OTH', 'AC1', 789, false, now()::date + 1, '09:00', '10:30', now()::timestamp, 'OTHER.USER');
INSERT INTO appointment_occurrence (appointment_occurrence_id, appointment_id, sequence_number, internal_location_id, in_cell, start_date, start_time, end_time)
VALUES (203, 103, 1, 789, false, now()::date + 1, '09:00', '10:30');
INSERT INTO appointment_occurrence_allocation (appointment_occurrence_allocation_id, appointment_occurrence_id, prisoner_number, booking_id)
VALUES (303, 203, 'D4567EF', 459);

--Group appointments--
--Prisoners A1234BC and B2345CD, Category AC1, Location 123, Starting three days ago 09:00-10:30, Repeating weekly 4 times, One edited, One cancelled, One deleted, Created by TEST.USER
...
VALUES (110, 'GROUP', 'TPR', 'AC1', 123, false, now()::date - 3, '09:00', '10:30', 10, now()::timestamp, 'TEST.USER');
INSERT INTO appointment_occurrence (appointment_occurrence_id, appointment_id, sequence_number, internal_location_id, in_cell, start_date, start_time, end_time)
VALUES (210, 110, 1, 123, false, now()::date - 3, '09:00', '10:30');
...
VALUES (211, 110, 2, 456, false, now()::date + 4, '13:30', '15:00', now()::timestamp, 'DIFFERENT.USER');
...
VALUES (212, 110, 3, 123, false, now()::date + 11, '09:00', '10:30', now()::timestamp, 2, 'DIFFERENT.USER');
...
VALUES (213, 110, 4, 123, false, now()::date + 18, '09:00', '10:30', now()::timestamp, 1, 'DIFFERENT.USER', true);
INSERT INTO appointment_occurrence_allocation (appointment_occurrence_allocation_id, appointment_occurrence_id, prisoner_number, booking_id)
