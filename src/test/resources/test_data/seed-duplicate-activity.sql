...
values (99, 'MDI', 1, 1, true, false, false, false, 'H', 'Maths', 'Maths Level 1', '2022-10-10', '2024-02-12', 'high', '2022-9-21 00:00:00', 'SEED USER', true);

insert into activity_pay(activity_pay_id, activity_id, incentive_nomis_code, incentive_level, prison_pay_band_id, rate, piece_rate, piece_rate_items)
values (101, 99, 'BAS', 'Basic', 1, 125, 150, 1);

insert into activity_pay(activity_pay_id, activity_id, incentive_nomis_code, incentive_level, prison_pay_band_id, rate, piece_rate, piece_rate_items)
values (102, 99, 'BAS', 'Basic', 2, 225, 250, 1);

insert into activity_pay(activity_pay_id, activity_id, incentive_nomis_code, incentive_level, prison_pay_band_id, rate, piece_rate, piece_rate_items)
values (103, 99, 'BAS', 'Basic', 3, 325, 350, 1);
...
values (99, 99, '1', 'Reading Measure 1.0', 'ENGLA', 'English Language');

insert into activity_schedule(activity_schedule_id, activity_id, description, internal_location_id, internal_location_code, internal_location_description, capacity, start_date)
values (99, 99, 'Maths AM', 1, 'L1', 'Location 1', 10, '2022-10-10');
...
values (99, 99, '10:00:00', '11:00:00', true, 'AM');