...
values (1, 'PVI', 1, 1, true, false, false, false, 'H', 'Instance test', 'Instance test', '2022-10-10', null, 'high', 'BAS', 'Basic', '2022-9-21 00:00:00', 'SEED USER', true);
...
insert into scheduled_instance(activity_schedule_id, session_date, start_time, end_time, cancelled, cancelled_time, cancelled_by, cancelled_reason, comment)
values (1, '2022-10-11', '10:00:00', '11:00:00', false, null, null, null, null);
