...
VALUES (1, 'INDIVIDUAL', 'TPR', 'AC1', 'Appointment description', 1, 123, false, now()::date + 1, '09:00', '10:30', 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (2, 1, 1, 'TPR', 'AC1', 'Appointment description', 1, 123, false, now()::date + 1, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
