...
VALUES (3, 'INDIVIDUAL', 'OIC', 'Appointment description', 1, 'MDI', 123, false, '2022-10-01', '09:00', '10:30', 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (4, 3, 1, 'MDI', 'OIC', 'Appointment description', 1, 123, false, '2022-10-01', '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
