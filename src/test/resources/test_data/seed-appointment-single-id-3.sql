...
VALUES (3, 'INDIVIDUAL', 'AC1', 'Appointment description', 4, 'MDI', 123, false, '2022-10-01', '09:00', '10:30', 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (4, 3, 1, 'MDI', 'AC1', 'Appointment description', 4, 123, false, '2022-10-01', '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
