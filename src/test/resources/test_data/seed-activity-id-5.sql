...
values (5, 'PVI', 1, 1, false, 'Gym', 'Gym induction', current_date, null, null, null, current_timestamp, 'SEED USER');
...
values (1, 5, 'Gym induction AM', '10:00:00', '11:00:00', 1, 'L1', 'Location 1', 10, true);
