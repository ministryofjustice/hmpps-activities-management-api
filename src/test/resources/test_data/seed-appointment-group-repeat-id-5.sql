...
VALUES (5, 'GROUP', 'TPR', 'AC1', 4, 123, false, now()::date - 3, '09:00', '10:30', 1, 'Appointment series level comment', now()::timestamp, 'TEST.USER');
...
VALUES (10, 5, 1, 'TPR', 'AC1', 4, 123, false, now()::date - 3, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, extra_information, created_time, created_by)
VALUES (11, 5, 2, 'TPR', 'AC1', 4, 123, false, now()::date + 4, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, extra_information, created_time, created_by)
VALUES (12, 5, 3, 'TPR', 'AC1', 4, 123, false, now()::date + 11, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
INSERT INTO appointment (appointment_id, appointment_series_id, sequence_number, prison_code, category_code, appointment_tier_id, internal_location_id, in_cell, start_date, start_time, end_time, extra_information, created_time, created_by)
VALUES (13, 5, 4, 'TPR', 'AC1', 4, 123, false, now()::date + 18, '09:00', '10:30', 'Appointment level comment', now()::timestamp, 'TEST.USER');
