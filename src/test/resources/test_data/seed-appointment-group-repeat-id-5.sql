...
VALUES (5, 'GROUP', 'TPR', 'OIC', 1, 123, '44444444-1111-2222-3333-444444444444', false, now()::date - 3, '09:00', '10:30', 1, 'Appointment series level comment', now()::timestamp, 'TEST.USER');
