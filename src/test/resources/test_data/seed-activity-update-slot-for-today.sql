...
values (1, 'MDI', 1, 1, true, false, false, false, 'H', 'Maths', 'Maths Level 1', current_date, null, 'high', '2022-9-21 00:00:00', 'SEED USER', true);
...
insert into activity_schedule_slot(activity_schedule_id, start_time, end_time, monday_flag, tuesday_flag, wednesday_flag, thursday_flag, friday_flag, saturday_flag, sunday_flag, time_slot)
values (1, '10:00:00', '11:00:00', true, true, true, true, true,true, true,'AM');

insert into activity_schedule_slot(activity_schedule_id, start_time, end_time, monday_flag, tuesday_flag, wednesday_flag, thursday_flag, friday_flag, saturday_flag, sunday_flag, time_slot)
values (1, '17:00:00', '18:00:00', true, true, true, true, true,true, true,'PM');
...
insert into allocation(allocation_id, activity_schedule_id, prisoner_number, booking_id, prison_pay_band_id, start_date, end_date, allocated_time, allocated_by, deallocated_time, deallocated_by, deallocated_reason, suspended_time, suspended_by, suspended_reason, prisoner_status)
values (2, 1, 'A22222A', 10002, 2, current_date, null, '2022-10-10 09:00:00', 'MRS BLOGS', null, null, null, null, null, null, 'ACTIVE');
...
values (1, current_timestamp, '18:00:00', '20:00:00', false, null, null, null, null, 'ED');
...
values (1, 'A11111A', null, null, current_timestamp, 'BLOGGSJ', 'COMPLETED', 100, null, null);

insert into attendance(scheduled_instance_id, prisoner_number, attendance_reason_id, comment, recorded_time, recorded_by, status, pay_amount, bonus_amount, pieces)
values (1, 'A22222A', null, null, current_timestamp, 'BLOGGSJ', 'COMPLETED', 100, null, null);
